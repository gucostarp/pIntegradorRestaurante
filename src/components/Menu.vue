  ...
  <ion-menu content-id="main" side="start" id="main-menu" v-if="currentUser">
    ...
    <ion-content>
      <ion-list>
        ...
        <ion-menu-toggle auto-hide="false">
          <ion-item button @click="$router.push('/cardapio')">
            <ion-icon name="cardapio"></ion-icon>
            <ion-label>
              <span :class="[{boldLabel : isActive('/cardapio') }, 'menu-label']">Cardápio</span>
            </ion-label>
          </ion-item>
        </ion-menu-toggle>
        <ion-menu-toggle auto-hide="false">
          <ion-item button @click="$router.push('/about')">
            ...
            <ion-label>
              <span :class="[{boldLabel : isActive('/about') }, 'menu-label']">Sobre</span>
            </ion-label>
          </ion-item>
        </ion-menu-toggle>
      </ion-list>
    ...
    <ion-footer style="text-align:center" class="ion-padding">
      <ion-button @click="logout()" color="success">SAIR</ion-button>
    </ion-footer>
  </ion-menu>
</template>
